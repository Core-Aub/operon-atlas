...
.import --skip 1 data/genomes.tsv genomes
.import --skip 1 data/products.tsv products
.import --skip 1 data/contigs.tsv contigs

.import --skip 1 data/operons.tsv operons
.import --skip 1 data/occurrences.tsv occurrences
.import --skip 1 data/occurrence_genes.tsv occurrence_genes
.import --skip 1 data/operon_products.tsv operon_products

.import --skip 1 data/ec_numbers.tsv ec_numbers
.import --skip 1 data/pathway_classes.tsv pathway_classes
.import --skip 1 data/pathway_reference.tsv pathway_reference
.import --skip 1 data/gene_pathways.tsv gene_pathways

.import --skip 1 data/subsystem_roles.tsv subsystem_roles
.import --skip 1 data/subsystem_classes.tsv subsystem_classes
.import --skip 1 data/subsystem_reference.tsv subsystem_reference
.import --skip 1 data/gene_subsystems.tsv gene_subsystems
...
.import --skip 1 data/operon_function_coverage.tsv operon_function_coverage
.import --skip 1 data/operon_subsystem_support.tsv operon_subsystem_support
.import --skip 1 data/operon_subsystem_class_support.tsv operon_subsystem_class_support
.import --skip 1 data/operon_pathway_support.tsv operon_pathway_support
.import --skip 1 data/operon_pathway_class_support.tsv operon_pathway_class_support

.import --skip 1 data/genome_taxonomy.tsv genome_taxonomy
.import --skip 1 data/operon_taxonomy_counts.tsv operon_taxonomy_counts
.import --skip 1 data/operon_pgfams.tsv operon_pgfams
.import --skip 1 data/operon_ec_support.tsv operon_ec_support
.import --skip 1 data/operon_role_support.tsv operon_role_support
.import --skip 1 data/search_entities.tsv search_entities
...
('source_files', 'All TSV files imported by database/build_db.sql from database/data/.'),
...
('search_taxonomy', 'Genome taxonomy, family breadth, PGFam/EC/role reverse support, and the search entity catalog are canonical schema tables imported from database/data/.');
-- ============================================================
-- Sanity checks
-- ============================================================
